        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <a 
              ...
              className="text-[#137fec] hover:underline flex items-center gap-1"
            >
              Learn more
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs text-slate-400">{issue.criterion}</span>
          </div>
              ...
              >
                ...
                {issue.fix && (
                  <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded-lg mb-3">
                    <div className="text-xs font-bold text-slate-500 uppercase mb-1">How to fix</div>
