        ...
        <AnimatePresence>
          {leftPanelOpen && (
            <motion.aside
              ...
              className="border-r border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#101922]/30 flex flex-col shrink-0"
            >
          ...
          <div className="px-4 py-2 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1 px-2 py-1 text-xs text-slate-500 hover:text-slate-700 dark:hover:text-slate-300 rounded hover:bg-slate-100 dark:hover:bg-slate-800"
              >
            ...
            <AnimatePresence>
              {showRollback && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -20 }}
                  className="absolute top-4 left-4 w-64 bg-white dark:bg-slate-900 rounded-lg shadow-xl border border-slate-200 dark:border-slate-700 p-4"
                >
                  <RollbackPanel 
                    history={history}
        ...
        <AnimatePresence>
          {rightPanelOpen && (
            <motion.aside
              ...
              exit={{ width: 0, opacity: 0 }}
              className="border-l border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#101922]/30 flex flex-col shrink-0"
            >
              <RightPanelContent 
                activeMode={activeMode}
                content={content}
...
function TopToolbar({ 
  ...
  return (
    <div className="h-14 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0d1117] flex items-center justify-between px-4 shrink-0">
...
function RollbackPanel({ history, currentIndex, onRollback }: {
  ...
  return (
    <div className="space-y-2">
      <h4 className="font-semibold text-slate-700 dark:text-slate-200">Version History</h4>
...
function ResearchPanel() {
  return (
    <div className="p-4">
      ...
      <div className="space-y-2">
        <button className="w-full p-3 bg-slate-100 dark:bg-slate-800 rounded-lg text-left">
          <div className="font-medium">Web Search</div>
          <div className="text-sm text-slate-500">Search the web for sources</div>
        </button>
        <button className="w-full p-3 bg-slate-100 dark:bg-slate-800 rounded-lg text-left">
          <div className="font-medium">Citation Manager</div>
          <div className="text-sm text-slate-500">Manage your references</div>
        </button>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-4">
      ...
      <div className="space-y-1">
        ...
        <div className="p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg cursor-pointer">
