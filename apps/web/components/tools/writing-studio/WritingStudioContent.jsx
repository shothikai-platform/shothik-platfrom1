...
function WorkspaceView({ project, onBack }) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] overflow-hidden bg-[#f6f7f8] dark:bg-[#101922] text-slate-900 dark:text-slate-100" style={{ fontFamily: "'Inter', sans-serif" }}>
      <WorkspaceHeader
        activeTab={activeTab}
