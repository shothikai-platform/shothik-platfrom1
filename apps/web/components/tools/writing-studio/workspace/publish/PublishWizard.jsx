            ...
            <div className="flex flex-col items-center gap-1.5">
              <div
                className={cn(
                  ...
                  isActive && "bg-[#137fec] border-[#137fec] text-white shadow-lg shadow-[#137fec]/30 scale-110",
                  isCompleted && "bg-emerald-500 border-emerald-500 text-white",
                  isPast && !isCompleted && "bg-slate-300 dark:bg-slate-600 border-slate-300 dark:border-slate-600 text-white",
                  !isActive && !isCompleted && !isPast && "bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 text-slate-400"
                )}
              >
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {book.reviewNotes && (
            <div className="bg-white/60 dark:bg-slate-800/40 rounded-lg p-3 mb-3 border border-amber-100 dark:border-amber-800/20">
              <p className="text-xs font-bold text-slate-500 mb-1">Reviewer Notes:</p>
              <p className="text-sm text-slate-700 dark:text-slate-300">{book.reviewNotes}</p>
            </div>
          )}
          <button
      ...
      >
        <div className="text-center max-w-md">
          ...
          <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-2">
            Your book <span className="font-bold text-slate-900 dark:text-white">"{formData.title}"</span> has been {isResubmission ? "resubmitted" : "submitted"} successfully.
          </p>
          ...
          <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 text-left space-y-2">
            ...
            <div className="flex justify-between text-sm">
              <span className="text-slate-500">{isResubmission ? "Resubmitted" : "Submitted"}</span>
            ...
            {STEPS.map((_, i) => (
              <button
                ...
                className={cn(
                  ...
                  i === currentStep ? "bg-[#137fec] w-6" : "bg-slate-300 dark:bg-slate-600 hover:bg-slate-400"
                )}
          ...
          {currentStep < STEPS.length - 1 ? (
            <button
              ...
              className={cn(
                ...
                canProceed
                  ? "bg-[#137fec] text-white hover:bg-[#137fec]/90 shadow-lg shadow-[#137fec]/20"
