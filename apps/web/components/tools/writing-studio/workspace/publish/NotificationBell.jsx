            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 dark:border-slate-800">
              ...
              {unreadCount > 0 && (
                <button
                  ...
                  className="text-[10px] text-[#137fec] font-bold hover:underline"
                >
                  Mark all read
                </button>
              )}
            ...
            <div className="max-h-80 overflow-y-auto">
              {unreadCount === 0 ? (
                ...
                notifications.map((item) => {
                  ...
                  const colors = NOTIF_COLORS[item.notification.type] || "text-slate-500 bg-slate-100 dark:bg-slate-800";

                  return (
                    <div
                      key={item.notification.id}
                      className="flex items-start gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/50 border-b border-slate-50 dark:border-slate-800/50 last:border-0 cursor-pointer"
                      onClick={() => {
