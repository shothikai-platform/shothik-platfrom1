    ...
    <div className="space-y-6">
        ...
        <div>
          {!formData.coverFile ? (
              ...
              {isProcessing ? (
                <div className="space-y-3">
                  <motion.div
                    ...
                    className="size-12 border-3 border-[#137fec]/20 border-t-[#137fec] rounded-full mx-auto"
                  />
                  <p className="text-sm text-slate-500">Processing image...</p>
                </div>
              ) : (
                <>
                  <div className="size-14 bg-slate-100 dark:bg-slate-800 text-slate-400 rounded-full flex items-center justify-center mb-4">
            ...
            <motion.div
              ...
              className="relative group aspect-[2/3] rounded-2xl overflow-hidden shadow-2xl shadow-black/20 border border-slate-200 dark:border-slate-800"
            >
              <img
              ...
              <div className="absolute inset-0 bg-slate-950/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-3">
                <button
                  onClick={() => fileInputRef.current?.click()}
                  className="bg-white text-slate-900 px-4 py-2 rounded-full text-xs font-bold hover:bg-[#137fec] hover:text-white transition-all"
                >
                  Change Cover
                </button>
                <button
        ...
        <div className="space-y-4">
          {formData.coverFile && formData.coverDimensions && (
            <motion.div
              ...
              className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-5 space-y-4"
            >
      ...
      {showFullPreview && formData.coverPreview && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/90 backdrop-blur-sm p-8"
