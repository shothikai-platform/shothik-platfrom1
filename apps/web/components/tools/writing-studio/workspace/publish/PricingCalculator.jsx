    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                max="200"
                step="0.01"
                className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl pl-10 pr-16 py-4 text-2xl font-black text-slate-900 dark:text-white focus:ring-2 focus:ring-[#137fec] focus:border-transparent outline-none transition-all"
                aria-label="List price in USD"
              />
              <span className="absolute right-4 top-1/2 -translate-y-1/2 text-sm font-bold text-slate-400">USD</span>
            </div>
          ...
          <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-4">
              <PieChart className="h-4 w-4 text-[#137fec]" />
            ...
            <div className="mt-4 space-y-3">
              ...
              <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800">
                <span className="text-sm text-slate-500">Google&apos;s share (30%)</span>
                <span className="text-sm font-bold text-slate-400">-${calculations.googleCut.toFixed(2)}</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800">
                <span className="text-sm text-slate-500">Net from Google (70%)</span>
                <span className="text-sm font-bold">${calculations.googleRevenue.toFixed(2)}</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:border-slate-800">
                <span className="text-sm text-slate-500">Shothik commission (15%)</span>
                <span className="text-sm font-bold text-slate-400">-${calculations.commission.toFixed(2)}</span>
              </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-6">
            <div className="flex items-center gap-2 mb-4">
              <Calculator className="h-4 w-4 text-[#137fec]" />
            ...
            <div className="mb-5">
              ...
              <div className="flex justify-between text-xs text-slate-400 mt-1">
                <span>1</span>
                <span className="font-bold text-[#137fec]">{monthlySales} sales/month</span>
                <span>500</span>
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <select
                ...
                className="w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#137fec] focus:border-transparent outline-none"
          ...
          <div className="bg-[#137fec]/5 border border-[#137fec]/20 rounded-xl p-4">
            <div className="flex items-start gap-2">
              <Info className="h-4 w-4 text-[#137fec] mt-0.5 shrink-0" />
              <div className="text-xs text-slate-600 dark:text-slate-400 space-y-1.5">
                <p className="font-bold text-[#137fec]">How royalties work</p>
