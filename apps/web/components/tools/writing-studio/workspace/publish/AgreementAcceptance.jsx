    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {keyTerms.map(({ icon: Icon, label, desc }) => (
          <div
            key={label}
            className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-3 text-center"
          >
      ...
      <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden">
        <div className="bg-slate-50 dark:bg-slate-800/50 px-6 py-3 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <FileCheck className="h-4 w-4 text-[#137fec]" />
            <h3 className="text-sm font-bold">Shothik AI Publishing Agreement</h3>
          </div>
          <span className="text-[10px] text-slate-400 font-mono">v{AGREEMENT_VERSION}</span>
        </div>
      ...
      <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 space-y-5">
        ...
        >
          <input
            ...
            className="mt-1 size-5 rounded border-slate-300 text-[#137fec] focus:ring-[#137fec] accent-[#137fec]"
          />
          <span className="text-sm text-slate-700 dark:text-slate-300">
            I have read and agree to the{" "}
            <span className="font-bold text-[#137fec]">Shothik AI Publishing Agreement</span>{" "}
        ...
        <div>
          ...
          <input
            ...
            className={cn(
              "w-full bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-[#137fec] focus:border-transparent outline-none transition-all",
