...
export function ContextPanel() {
  ...
  return (
    <motion.div
      ...
      className="border-l border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#0d1520]/50 flex flex-col shrink-0 relative"
      style={{ width: panelWidth }}
    >
      <div
        onMouseDown={handleMouseDown}
        className="absolute left-0 top-0 bottom-0 w-1 cursor-col-resize hover:bg-[#137fec]/20 transition-colors z-10"
      />
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        selectedTool === tool.id
                          ? "border-[#137fec] bg-[#137fec]/5 ring-1 ring-[#137fec]"
                          : "border-slate-200 dark:border-slate-700 hover:border-[#137fec]/50 hover:bg-slate-100 dark:hover:bg-slate-800/50"
                      )}
                    >
                      <div className="flex items-start gap-2.5">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5 truncate">{tool.description}</p>
                        </div>
                      </div>
                    </button>
                  ))}
                  ...
                  {selectedTool === "paraphrase" && (
                    <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
                      <p className="text-[10px] font-medium mb-2 text-slate-500">Mode</p>
                          ...
                          <button
                            ...
                            className={cn(
                              ...
                              selectedMode === mode.id
                                ? "border-[#137fec] bg-[#137fec]/10 text-[#137fec] font-medium"
                                : "border-slate-200 dark:border-slate-700 hover:border-[#137fec]/50"
                            )}
                          >
                            {mode.name}
                          </button>
                  ...
                  {selectedTool && (
                    <Button
                      ...
                      className="w-full bg-[#137fec] hover:bg-[#137fec]/90"
                      size="lg"
                    >
                      {isProcessing ? (
              ...
              {activeTab === "improve" && (
                ...
                >
                  ...
                  {wordCount < 50 && (
                    <p className="text-[10px] text-slate-400 text-center">50+ words needed for AI detection</p>
                  )}
                  <Separator />
                  <PlagiarismCheckPanel
        ...
        <div className="p-3 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-[#101922]/50">
          <div className="relative">
            <textarea
              className="w-full bg-slate-100 dark:bg-slate-800 border-none rounded-xl text-xs p-3 pr-10 focus:ring-1 focus:ring-[#137fec] min-h-[60px] resize-none placeholder:text-slate-400"
            ...
            />
            <button
              className="absolute bottom-2 right-2 p-1.5 bg-[#137fec] text-white rounded-lg hover:bg-[#137fec]/90 transition-colors"
              onClick={() => {
          ...
          <div className="mt-1.5 flex items-center justify-between text-[10px] text-slate-500 dark:text-slate-400">
            <span className="flex items-center gap-1">
              <Zap className="h-3 w-3 text-[#137fec]" />
              Gemini Active
            </span>
