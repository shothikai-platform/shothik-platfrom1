    ...
    <div className="flex-1 overflow-y-auto">
      <div className="max-w-2xl mx-auto py-12 px-8 min-h-full">
        <BubbleMenu editor={editor}>
          <div className="flex items-center gap-0.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl p-1 backdrop-blur-sm">
            <Button
              size="sm"
              variant="ghost"
