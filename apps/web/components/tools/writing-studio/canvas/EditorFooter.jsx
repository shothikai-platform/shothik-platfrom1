...
export function EditorFooter() {
  ...
  return (
    <div className="h-9 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 bg-slate-50/80 dark:bg-[#0d1520]/30 shrink-0">
      ...
      <div className="flex items-center gap-3">
        {wordCount > 20 && toneScore > 0 && (
          <div className={cn("flex items-center gap-1 text-[10px] font-medium px-2 py-0.5 rounded bg-[#137fec]/10", toneColor)}>
            Tone: {toneLabel}
          </div>
        )}
