...
export const disableAutoFreezeTerm = async (
  ...
  try {
    response = await fetch(`${API_BASE}/auto-freeze/disable`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export const enableAutoFreezeTerm = async (
  ...
  let response: Response;
  try {
    response = await fetch(`${API_BASE}/auto-freeze/enable`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${accessToken}`,
...
export const getDisabledTerms = async (
  ...
  let response: Response;
  try {
    response = await fetch(`${API_BASE}/auto-freeze/disabled-terms`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${accessToken}`,
